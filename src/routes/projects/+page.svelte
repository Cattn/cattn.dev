<script lang="ts">
    ...
    let collabProjects = [
        { title: 'Nebula', description: 'a stunning and sleek web proxy with support for hundreds of popular sites.', link: 'https://github.com/NebulaServices/Nebula' },
        { title: 'Noctura', description: 'The blazing fast solution to internet censorship. Access blocked websites with ease while maintaining anonymity and security.', link: 'https://github.com/NebulaServices/Noctura' },
        { title: 'Atlas', description: 'Atlas is a minimalistic proxy service packed with important features for a simple, streamlined proxy experience. Made for the 2024 Titanium Network Proxathon', link: 'https://github.com/atlasproxy/atlas' },
    ]   
</script>
